...
| :----: | :---------------------------------------: |
|   语言   |                  Python                   |
| 命令行支持  | [click](https://github.com/pallets/click) |
| HTTP支持 | [httpx](https://github.com/encode/httpx/) |
...
|   特性   |                                说明                                |
| :----: | :--------------------------------------------------------------: |
| 🔗 跨平台 | [轻昼CE](https://github.com/shijuhao/QingZhouCE)局限于安卓，本cli可在任意平台运行 |
## 📧 联系方式


| 方式  |           账号            |
| :-: | :---------------------: |
| 邮箱  | qw39337891m@outlook.com |
| 云湖  |         3728027         |
